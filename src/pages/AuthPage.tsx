      ...
      <div className="relative z-10 w-full max-w-sm animate-fade-up">
        ...
        <form onSubmit={handleSubmit} className="glass-card p-6 space-y-4">
          ...
          <button
            ...
            className="w-full py-3 rounded-xl bg-background border border-border text-foreground font-semibold hover:bg-accent transition-all disabled:opacity-50 flex items-center justify-center gap-2"
          >
